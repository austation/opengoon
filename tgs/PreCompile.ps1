...
Add-Content -Path $build_file -Value "#define BUILD_TIME_MONTH $(Get-Date -Format 'MM')"
Add-Content -Path $build_file -Value "#define BUILD_TIME_DAY $(Get-Date -Format 'dd')"
Add-Content -Path $build_file -Value "#define BUILD_TIME_HOUR $(Get-Date -Format 'HH')"
Add-Content -Path $build_file -Value "#define BUILD_TIME_MINUTE $(Get-Date -Format 'mm')"
Add-Content -Path $build_file -Value "#define BUILD_TIME_SECOND $(Get-Date -Format 'ss')"
